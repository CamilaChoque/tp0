...
int main(void)
{
	...
	log_info(logger,"Log de valor ip: %s",ip);
	log_info(logger,"Log de valor puerto: %s",puerto);
	log_info(logger,"Log de valor clave: %s",valor);
	//config_destroy(config);
	//log_destroy(logger); lo saco porque quiero que los mensajes luego del readline se guarde al tp0
	...
	//leer_consola(logger); --lo pongo despues para que se considere
	//log_destroy(logger);
	/*---------------------------------------------------PARTE 3-------------------------------------------------------------*/
